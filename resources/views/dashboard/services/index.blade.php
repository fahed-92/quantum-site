...
@section('title', 'جميع ميزات التطبيق')
@section('content')
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">{{ __('messages.Product\'s features') }}</li>
                    </ol>
                </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">{{ __('messages.All Product\'s features') }}</p>
                    ...
                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                        <thead>
                            <tr>
                                <th width="10">#</th>
                                <th>{{ __('messages.feature title') }}</th>
                                <th>{{ __('messages.feature description') }}</th>
{{--                                <th>{{ __('messages.service picture') }}</th>--}}
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $row->id }}</td>
                                <td>{{ $row->title }}</td>
                                <td>{!! Str::limit(strip_tags($row->description), 30, ' (...)') !!}</td>
{{--                                <td><img src="{{ $row->image }}" class="img-fluid" width="60" alt=""></td>--}}
                                <td>
                                    <a href="{{ route('dashboard.'.$module_name_plural.'.edit', $row->id) }}" class="btn btn-primary btn-sm waves-effect btn-label waves-light"><i class="bx bx-cog label-icon"></i> {{ __('messages.edit') }}</a>
...
@push('scripts')
    ...
    <!-- Buttons {{ asset('backend') }}/examples -->
