            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">{{ __('messages.Clients and partners') }}</li>
                    </ol>
                </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">{{ __('messages.Clients and partners') }}</h4>
                    <p class="card-title-desc">{{ __('messages.all items') }}</p>
                    ...
                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $row->title }}</td>
                                <td>
                                    <div class="holder" style="max-height:70px; overflow: hidden; object-fit: contain;">
                                        <img src="{{asset('frontend/assets/img/folder/' . $row->image)}}" class="img-fluid" width="70" alt="">
                                    </div>
                                </td>
                                <td>
