										...
										<tbody>
											<tr>
												<td align="center" valign="middle"
													style="padding-top: 40px; padding-bottom: 40px;" class="emailLogo">
													<!-- Logo and Link // -->
													<a href="#" target="_blank" style="text-decoration:none;">
														<img src="{{ asset('frontend/assets/img/logo.svg') }}"
									...
									<table border="0" cellpadding="0" cellspacing="0"
										...
										<tbody>
											<tr>
												<!-- Header Top Border // -->
												<td height="3"
													style="background-color:#27348b;font-size:1px;line-height:3px;"
													class="topBorder">&nbsp;</td>
											</tr>
											<tr>
												<td align="center" valign="top" style="padding-bottom: 20px;padding-top: 55px;" class="imgHero">
													<!-- Hero Image // -->
													<a href="#" target="_blank" style="text-decoration:none;">
														<img src="https://www.pngall.com/wp-content/uploads/2/Email-PNG-Download-Image.png" width="600" alt="" border="0" style="width:100%;max-width: 320px;height:auto;display:block;">
													</a>
												</td>
											</tr>
											<tr>
												<td align="center" valign="top"
													style="padding-bottom: 5px; padding-left: 20px; padding-right: 20px;padding-top: 45px;"
													class="mainTitle">
													<!-- Main Title Text // -->
													<h2 class="text"
											...
											<tr>
												<td align="center" valign="top"
													...
													<!-- Sub Title Text // -->
													<h4 class="text"
														style="color: green; font-family:'Poppins', Helvetica, Arial, sans-serif; font-size:16px; font-weight:500; font-style:normal; letter-spacing:normal; line-height:24px; text-transform:none; text-align:center; padding:0; margin:0">
														رسالة جديدة
													</h4>
												</td>
											</tr>
															...
															<tr>
																<td align="center" valign="top"
																	...
																	<p class="text"
                                                                        ...
                                                                        رقم الهاتف : {{ $details['phone'] }} <br />
                                                                        البريد الإلكتروني : {{ $details['email'] }} <br />
																	</p>
                                                                    <p class="text"
                                                                    style="color:#666666; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:center; padding:0; margin:0">
                                                                   {{ $details['messages'] }}
											...
											<tr>
												<td align="center" valign="top" style="padding: 10px 10px 5px;"
													...
													<p class="text"
														...
														©&nbsp; 2022 <a href="https://medianature.ae/">Medianature</a>, All Rights Reserved
													</p>
												</td>
											</tr>
